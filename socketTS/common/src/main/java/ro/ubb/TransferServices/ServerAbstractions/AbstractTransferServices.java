...
public abstract class AbstractTransferServices<ID, E extends BaseEntity<ID>> implements ITransferService<ID, E> {
    ...
    protected AbstractTransferServices(String service_signature) {
