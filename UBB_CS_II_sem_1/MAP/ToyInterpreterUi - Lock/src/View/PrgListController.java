...
public class PrgListController implements Initializable {
    ...
    public void setUp() {
        IStmt ex0 = new CompStmt(
                new CompStmt(new CompStmt(new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())),
               new VarDeclStmt("v2", new RefType(new IntType()))),
                new HeapAllocStmt("v1", new ValueExp(new IntValue(20)))),
                new CompStmt(new HeapAllocStmt("v2", new ValueExp(new IntValue(30))),
                        new CompStmt(new CreateLockStmt("x"),
                        new ForkStmt(new CompStmt(new ForkStmt(new CompStmt(new LockStmt("x"),
                                new CompStmt(new HeapWriteStmt("v1", new ArithmExp('-',new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(1)))),
                                        new UnlockStmt("x")))
                                ),
                ...
                new CompStmt(new ForkStmt(new CompStmt(new ForkStmt(new HeapWriteStmt("v2", new ArithmExp('+',new ReadHeapExp(new VarExp("v2")),new ValueExp(new IntValue(1))))),
                        new CompStmt(new HeapWriteStmt("v2", new ArithmExp('+',new ReadHeapExp(new VarExp("v2")),new ValueExp(new IntValue(1)))),new UnlockStmt("x"))))
                        ,new CompStmt(new CompStmt(new LockStmt("x"),new PrintStmt(new ReadHeapExp(new VarExp("v1")))),
                        new CompStmt(new PrintStmt(new ReadHeapExp(new VarExp("v2"))),new UnlockStmt("x")))));
